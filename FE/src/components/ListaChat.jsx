  ...
  return (
    <aside className="sidebar">
      ...
      <form className="nuova-chat" onSubmit={crea}>
        <input value={nome} onChange={(e) => setNome(e.target.value)} placeholder="Nome della chat" maxLength={100} />
      ...
      <ul>
        {chat.map((c) => (
          <li key={c.id}>
            ...
            <button type="button" className="elimina" title="Elimina chat" onClick={() => onElimina(c)}>×</button>
          </li>
        ))}
      </ul>
      <Avviso testo={errore} />
